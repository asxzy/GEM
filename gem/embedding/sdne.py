...
class SDNE(StaticGraphEmbedding):
	...
	def learn_embedding(self, graph=None, edge_f=None, is_weighted=False, no_python=False):
		...
		# Outputs
		x_diff1 = merge([x_hat1, x1], mode=lambda a_b: a_b[0] - a_b[1], output_shape=lambda L: L[1])
		x_diff2 = merge([x_hat2, x2], mode=lambda a_b1: a_b1[0] - a_b1[1], output_shape=lambda L: L[1])
		y_diff = merge([y2, y1], mode=lambda a_b2: a_b2[0] - a_b2[1], output_shape=lambda L: L[1])
